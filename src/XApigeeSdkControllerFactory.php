...
use Apigee\Edge\Api\Monetization\Controller\XDeveloperAcceptedRatePlanController;
 ...
 */
class XApigeeSdkControllerFactory implements XApigeeSdkControllerFactoryInterface {
   ...
   * {@inheritdoc}
   */
  public function developerAcceptedRatePlanController(string $developer_id): XDeveloperAcceptedRatePlanController {
    if (empty($this->controllers[__FUNCTION__][$developer_id])) {
      // Don't assume the bucket has been initialized.
      $this->controllers[__FUNCTION__] = $this->controllers[__FUNCTION__] ?? [];
      // Create a new balance controller.
      $this->controllers[__FUNCTION__][$developer_id] = new XDeveloperAcceptedRatePlanController(
        $developer_id,
        $this->getOrganization(),
        $this->getClient()
      );
