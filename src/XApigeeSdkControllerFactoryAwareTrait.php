 ...
 */
trait XApigeeSdkControllerFactoryAwareTrait {
   ...
   *
   * @return \Drupal\apigee_m10n\XApigeeSdkControllerFactoryInterface
   *   The controller factory.
   */
  public function controllerFactory(): XApigeeSdkControllerFactoryInterface {
    return \Drupal::service('apigee_m10n.sdk_controller_factory_product');
  }
