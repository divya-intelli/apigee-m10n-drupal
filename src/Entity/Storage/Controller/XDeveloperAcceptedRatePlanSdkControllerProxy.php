...
use Drupal\apigee_m10n\XApigeeSdkControllerFactoryAwareTrait;
 ...
 */
class XDeveloperAcceptedRatePlanSdkControllerProxy implements XDeveloperAcceptedRatePlanSdkControllerProxyInterface {

  use XApigeeSdkControllerFactoryAwareTrait;
  ...
  public function loadAll(): array {
    ...
    /** @var \Apigee\Edge\Api\Monetization\Entity\XDeveloperAcceptedRatePlanInterface[] $purchased_plans */
    $purchased_products = [];
   ...
   *
   * @return \Apigee\Edge\Api\Monetization\Controller\XAcceptedRatePlanControllerInterface
   *   The real rate plan controller.
   */
  protected function getPurchasedPlanController(EntityInterface $entity) {
    /** @var \Apigee\Edge\Api\Monetization\Entity\XDeveloperAcceptedRatePlanInterface $entity */
