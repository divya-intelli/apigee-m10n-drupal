...
use Drupal\apigee_m10n\Entity\Storage\Controller\XDeveloperAcceptedRatePlanSdkControllerProxyInterface;
...
class PurchasedProductStorage extends EdgeEntityStorageBase implements PurchasedProductStorageInterface {
  ...
  public function loadByDeveloperId(string $developer_id): array {
    ...
    $this->withController(function (XDeveloperAcceptedRatePlanSdkControllerProxyInterface $controller) use ($developer_id, &$entities) {
  ...
  protected function doSave($id, EntityInterface $entity) {
    ...
    $this->withController(function (XDeveloperAcceptedRatePlanSdkControllerProxyInterface $controller) use ($id, $entity, &$result) {
  ...
  public function loadById(string $developer_id, string $id): ?PurchasedProductInterface {
    ...
    $entity = NULL;
    $this->withController(function (XDeveloperAcceptedRatePlanSdkControllerProxyInterface $controller) use ($developer_id, $id, &$entity) {
