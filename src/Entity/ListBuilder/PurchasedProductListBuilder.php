...
abstract class PurchasedProductListBuilder extends EntityListBuilder implements ContainerInjectionInterface {
  ...
  public function buildRow(EntityInterface $entity) {
    ...
    return [
      'data' => [
        'plan' => [
          'data' => Link::fromTextAndUrl($entity->getApiProduct(), $this->ratePlanUrl($entity)),
        ...
        'start_date' => [
          'data' => $entity->getStartTime()->format('m/d/Y'),
          'class' => ['purchased-plan-start-date'],
        ],
        'end_date' => [
          'data' => $entity->getEndTime() ? $entity->getEndTime()->format('m/d/Y') : NULL,
          'class' => ['purchased-plan-end-date'],
        ],
  ...
  protected function getDefaultOperations(EntityInterface $entity) {
    ...
    if ($entity->access('update') && $entity->isActive() && (empty($entity->getEndTime())|| $today < $entity->getEndTime())) {
      $operations['cancel'] = [
        'title' => $this->t('Cancel'),
        'weight' => 10,
   ...
   */
  abstract protected function ratePlanUrl(PurchasedProductInterface $purchased_product);
